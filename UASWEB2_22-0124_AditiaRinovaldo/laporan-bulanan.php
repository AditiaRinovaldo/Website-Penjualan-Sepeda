            ...
            <div class="box">
                <table border="1" cellspacing="0" class="table">
                    ...
                    <tbody>
                        <?php
                            $no = 1;
                            $produk = mysqli_query($conn, "SELECT * FROM tb_month_report LEFT JOIN tb_report USING (category_name, product_name, product_price, product_count, total_price) ORDER BY product_name DESC");
                        ...
                        <?php 
                            ...
                            <tr>
                                <td colspan="6">Tidak ada laporan bulanan</td>
                            </tr>
                        <?php } ?>
